...
SAM_COMPACT_SAVE_PREFIXES = [
    ...
    'pseudo_labels_point_refine_case_a_before_binary',
    'pseudo_labels_point_refine_case_a_after_binary',
    'pseudo_labels_point_refine_case_b_before_binary',
    'pseudo_labels_point_refine_case_b_after_binary',
...
def build_sam_helper(config, save_root):
    ...
    return SAMTrainHelper(
        ...
        neg_points_per_component=config.get('sam_neg_points_per_component', 1),
        mask_prompt_fg_logit=config.get('sam_mask_prompt_fg_logit', 3.0),
        mask_prompt_bg_logit=config.get('sam_mask_prompt_bg_logit', -3.0),
        mask_prompt_uncertain_dilate=config.get('sam_mask_prompt_uncertain_dilate', 12),
        refine_missing_ratio_thresh=config.get('sam_refine_missing_ratio_thresh', 0.25),
        refine_missing_points=config.get('sam_refine_missing_points', 3),
