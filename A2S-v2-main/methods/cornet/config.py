...
def get_config():
    ...
    parser.add_argument('--sam-refine-missing-ratio-thresh', default=0.25, type=float, help='Missing CCAM high-activation ratio threshold for case-B point refine.')
    parser.add_argument('--sam-refine-missing-points', default=3, type=int, help='Max extra positive points sampled from missing CCAM high-activation regions during point refine.')
    parser.add_argument(
        '--sam-use-mask-prompt',
